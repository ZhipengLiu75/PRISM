...
class M4Dataset:
    ...
    def load(training: bool = True, dataset_file: str = '../dataset/m4') -> 'M4Dataset':
        ...
        if not os.path.isfile(info_file) or not os.path.isfile(train_cache_file) or not os.path.isfile(test_cache_file):
            print('M4 files is not existing or incomplete...')
